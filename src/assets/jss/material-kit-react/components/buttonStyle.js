...
const buttonStyle = {
  ...
  primary: {
    ...
    boxShadow:
      "0 2px 2px 0 rgba(33, 150, 250, 0.14), 0 3px 1px -2px rgba(156, 39, 176, 0.2), 0 1px 5px 0 rgba(33, 150, 250, 0.12)",
    "&:hover,&:focus": {
      backgroundColor: primaryColor,
      boxShadow:
        "0 14px 26px -12px rgba(33, 150, 250, 0.42), 0 4px 23px 0px rgba(0, 0, 0, 0.12), 0 8px 10px -5px rgba(33, 150, 250, 0.2)"
    }
  },
  info: {
  ...
  danger: {
    ...
    boxShadow:
      "0 2px 2px 0 rgba(23, 215, 183, 0.14), 0 3px 1px -2px rgba(244, 67, 54, 0.2), 0 1px 5px 0 rgba(23, 215, 183, 0.12)",
    "&:hover,&:focus": {
      backgroundColor: dangerColor,
      boxShadow:
        "0 14px 26px -12px rgba(23, 215, 183, 0.42), 0 4px 23px 0px rgba(0, 0, 0, 0.12), 0 8px 10px -5px rgba(23, 215, 183, 0.2)"
    }
  },
  rose: {
