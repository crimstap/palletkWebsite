...
class Sidebar extends React.Component {
            ...
            >
              {prop.icon !== undefined ? (
                typeof prop.icon === "string" ? (
                  <Icon style={{ color: "#696969" }} className={itemIcon}>
                    {prop.icon}
                  </Icon>
                ) : (
                  <prop.icon
          ...
          >
            {prop.icon !== undefined ? (
              typeof prop.icon === "string" ? (
                ...
                <prop.icon style={{ color: "#696969" }} className={itemIcon} />
              )
            ) : (
              <span className={collapseItemMini}>
                {rtlActive ? prop.rtlMini : prop.mini}
  ...
  render() {
      ...
      <div className={userWrapperClass}>
        ...
        <List className={classes.list}>
          <ListItem className={classes.item + " " + classes.userItem}>
            ...
            >
              <ListItemText
                primary={rtlActive ? "تانيا أندرو" : "Warehouse X"}
                secondary={
                  <b
                    className={
                      caret +
    ...
    var brand = (
      ...
      >
        <img src={logo} alt="logo" style={{ width: "13vw", heigh: "auto" }} />
      </div>
    );
    const drawerPaper =
      classes.drawerPaper +
